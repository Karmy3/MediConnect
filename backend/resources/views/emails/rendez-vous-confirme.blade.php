...
<body>
    <div class="container">
        ...
        <div class="body">
            ...
            <p>Votre rendez-vous a ete confirme par votre medecin. Voici le recapitulatif :</p>
            ...
            <p>Merci d'etre connecte a l'heure du rendez-vous. A bientot sur MediConnect.</p>
        </div>
        <div class="footer">
